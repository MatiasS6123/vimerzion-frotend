    ...
    this.faqs = [
      {
        ...
        respuesta: 'La edad recomendada para usar realidad virtual es a partir de los 10 años...'
      },
      {
        ...
        respuesta: 'Personas con epilepsia, embarazo, problemas de visión... deben consultar a un especialista.'
      }, 
      {
     ...
     
      {
        ...
        respuesta: 'Puedes estacionar en el estacionamiento del Mall Costanera Center...'
      },
      {
        origen: ['arriendo-en-local','salon-de-cumpleaos-en-local','otros-eventos-en-local','arriendo-del-local','salon-de-reuniones-en-local','team-building-en-local','eventos-corporativos-a-domicilio'],
      ...
      },
      {
        ...
        respuesta: 'Puedes llevar alimentos que no requieran cocción. Será responsabilidad del cliente el estado de los productos alimenticios...'
      },
      {
        origen: ['salon-de-cumpleaos-en-local'],
        pregunta: '¿Qué no se permite durante las celebraciones?',
        respuesta: 'No se puede llevar bebidas de ningún tipo, ni ingresar electrodomésticos...'
      },
      {
        origen: ['salon-de-cumpleaos-en-local'],
        pregunta: '¿Qué días y en qué horarios se puede celebrar un cumpleaños?',
        respuesta: 'Se puede celebrar de lunes a domingo. Horario 1: entre las 11:00 AM y las 15:00 PM...'
      },
      {
        origen: ['salon-de-cumpleaos-en-local'],
        pregunta: '¿Cuál es el mínimo y máximo de invitados (niños y adultos)?',
        respuesta: 'El mínimo es de 10 invitados...'
      },
      {
        origen: ['salon-de-cumpleaos-en-local'],
        pregunta: '¿Cuál es el procedimiento para reservar un cumpleaños?',
        respuesta: 'Puedes reservar a través del sitio web o de forma presencial...'
      },
      {
        origen: ['salon-de-cumpleaos-en-local'],
        pregunta: '¿Cuánto tiempo antes de la fecha del cumpleaños debo reservar o solicitar una modificación?',
        respuesta: 'Debes reservar con un mínimo de tres días hábiles...'
      },
      {
        origen: ['salon-de-cumpleaos-en-local'],
        pregunta: '¿Cuáles son los medios y formas de pago para la contratación de un cumpleaños?',
        respuesta: 'Para reservar, debes abonar un mínimo de $100.000...'
      },
      {
